...
public class AlgoFPGrowth {
	 ...
	 */
	public Itemsets runAlgorithm( ArrayList<String> input, String output, double minsupp) throws FileNotFoundException, IOException, NumberFormatException, SQLException {
		// record start time
		...
		//while( (input.next() && (line = input.getString(1))!= null)){ 
...
//			Set<Integer> alreadySeen = new HashSet<Integer>();
			...
			for(String itemString : lineSplited){  
				int item =getHashString(itemString);
...
//		System.out.println(tree);
	 ...
	 * @throws NumberFormatException 
	 */
	private  Map<Integer, Integer> scanDatabaseToDetermineFrequencyOfSingleItems(ArrayList<String> input)
		...
		//while( (input.next() && (line = input.getString(1))!= null)){ 
			...
			String cleanRow = line.substring(2, line.length()-2);
			// split the line into items
			String[] lineSplited = cleanRow.split(",");
